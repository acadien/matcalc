...
delT,msd,msdByAtom=meanSquareDist.meanSquareDistRef(atoms,0,nAtoms,nTime,lengths,byAtom=True)

msdfile=filename+".msd"
header=["AverageMSD PerAtomMSD\n"]
msddata=header+[str(y)+" "+" ".join(map(str,z))+"\n" for y,z in zip(msd,msdByAtom)]
